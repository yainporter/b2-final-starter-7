...
RSpec.describe Invoice, type: :model do
  ...
  describe "instance methods" do
    ...
    describe "#total_revenue_with_coupon" do
      it "displays the total revenue including the coupon discounts" do
        @merchant1 = Merchant.create!(name: 'Hair Care')
        ...
        expect(@invoice_1.total_revenue_with_coupon).to eq(90)
      end
    end
  end
end
